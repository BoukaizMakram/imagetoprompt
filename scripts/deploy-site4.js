...
const SITE_ID = "69746269-e569-403b-946c-61c01c926ff7";
const DEPLOY_DIR = "D:/tmp/site4-deploy";
...
async function main() {
  ...
  console.log("Deploying", Object.keys(fileHashes).length, "files to ai-image-prompt-tools...");
  ...
  console.log("DONE! https://ai-image-prompt-tools.netlify.app");
}

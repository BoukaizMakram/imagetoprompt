...
const SITE_ID = "a34e2310-d232-46f9-9cb8-797632f29c1c";
const DEPLOY_DIR = "D:/tmp/site5-deploy";
...
async function main() {
  ...
  console.log("Deploying", Object.keys(fileHashes).length, "files to image-prompt-workflow...");
  ...
  console.log("DONE! https://image-prompt-workflow.netlify.app");
}
